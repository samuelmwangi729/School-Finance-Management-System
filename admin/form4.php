...
<body>
				...
				<div class="table table-bordered table-success" style="padding-top: 20px">
					...
					<div class="row">
						...
						<div class="form-group">
							...
							<input type="number" name="class" class="form-control input-md" value="4" readonly>
						</div>
					</div>
					<div class="col-lg-4">
						<div class="form-group">
	...
	if(isset($_POST['submit'])){
		...
		echo "<script>alert('Fees Not Added');</script>";
		echo "<script>window.open('b4.php','_self');</script>";
	}
	}
	?>
	<?php 
