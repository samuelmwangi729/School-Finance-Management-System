...
<body>
				...
				<div class="table table-bordered table-success" style="padding-top: 20px">
					...
					<div class="col-lg-4">
						<div class="form-group">
							...
							<input type="text" name="reg1" class="form-control input-md" placeholder="Enter the Registration Number" value="<?php echo $reg?>" required="true" autofocus="true">
						</div>
					</div>
					<div class="col-lg-4">
						<div class="form-group">
					...
					<div class="col-lg-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="stream" value="<?php echo $stream?>">
						</div>
					</div>
				</div>
			</fieldset>
	...
	if(isset($_POST['submit'])){
		...
		$class=($_POST['class']);
		$stream=($_POST['stream']);
		$ins="UPDATE student  SET fname='$fname',sname='$sname',tname='$tname',gender='$gender',challenge='$physical',parent_name='$pname1',parent_occupation='$occupation',parent_contact='$phone',reg_no='$reg1',class='$class',stream='$stream' WHERE reg_no='$reg'";
