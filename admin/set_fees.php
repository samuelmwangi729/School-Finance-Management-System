...
<body>
	...
	<div class="container">
		<form method="POST" action="set_fees.php">
			<fieldset>
	...
	if(isset($_POST['submit'])){
		...
		$amount=($_POST['amount']);
		$ins="UPDATE fees SET amount='$amount' WHERE class='$class' AND votehead='$votehead'";
		$result=mysqli_query($conn,$ins);
		if($result){
		echo "<script>alert('Fees Successfully Updated ');</script>";
		echo "<script>window.open('set_fees.php','_self');</script>";
	}else{
